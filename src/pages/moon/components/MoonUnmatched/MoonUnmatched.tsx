import { moonUnmatchedData } from "../../../../data/MoonUnmatchedData"
    ...
    return (
        <section className="moon-unmatched">
            <div className="moon-unmatched__content">
                ...
                <h2 className="moon-unmatched__title">
                    {moonUnmatchedData.title}
                </h2>
            ...
            <img src={moonUnmatchedData.image} alt={moonUnmatchedData.title} className="moon-unmatched__image" />
