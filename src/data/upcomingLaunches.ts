...
import type { UpcomingLaunch } from "../types/upcomingLaunches.types";
...
export const upcomingLaunches: UpcomingLaunch[] = [
  {
    ...
    imageSrc: getPublicAssetPath("assets/pages/home/images/slc-4-e.jpg"),
  ...
  },
  {
    ...
    imageSrc: getPublicAssetPath("assets/pages/home/images/crew-12-mobile.jpg"),
