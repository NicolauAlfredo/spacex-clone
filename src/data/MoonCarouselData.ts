...

    {
        ...
        slides: [
            ...
            }, 
            {
                id: 3,
                title: "Tanker",
                description: "Used to deliver propellant to storage depots or landers in orbit around Earth. The tanker variant shares the same design as the core Starship vehicle and adds docking probes used to link up with other Starships in space.",
